...
* MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU Affero General Public License for more details. You should have 
* received a copy of the GNU Affero General Public License along with this program; if not, see http://www.gnu.org/licenses/ or write to 
* the Free Software Foundation, Inc., 51 Franklin Street, Fifth Floor, Boston, MA, 02110-1301 USA, or download the license from the 
* following URL: http://itextpdf.com/terms-of-use/
*
* The interactive user interfaces in modified source and object code versions of this program must display Appropriate Legal Notices, as 
...
*
* You can be released from the requirements of the license by purchasing a commercial license. Buying such a license is mandatory as soon 
* as you develop commercial activities involving the iText software without disclosing the source code of your own applications. These 
* activities include: offering paid services to customers as an ASP, serving PDFs on the fly in a web application, shipping iText with 
* a closed source product.
*
*
* Program Description: Proof of Concept for PDF splitting based on a specific word within the text (e.g., a document containing the 
* word "session" followed by a sequential integer id). The program outputs the total processing time and the error detection rate for 
* the said word and the id. It also demonstrates the use of meta-data manipulation and cropping via the 'Stamper' class.
*/
using System;
